...
// in simulator we redefine to format for BasketTimer Developer console
...
{\
	NSString * exceptionName = [@"org.baskettimer." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.baskettimer";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIBasketTimerNativeItemNone = -1, 
	UIBasketTimerNativeItemSpinner = -2,
	UIBasketTimerNativeItemProgressBar = -3,
	
	UIBasketTimerNativeItemSlider = -4,
	UIBasketTimerNativeItemSwitch = -5,
	UIBasketTimerNativeItemMultiButton = -6,
	UIBasketTimerNativeItemSegmented = -7,
	
	UIBasketTimerNativeItemTextView = -8,
	UIBasketTimerNativeItemTextField = -9,
	UIBasketTimerNativeItemSearchBar = -10,
	
	UIBasketTimerNativeItemPicker = -11,
	UIBasketTimerNativeItemDatePicker = -12,
	
	UIBasketTimerNativeItemInfoLight = -13,
	UIBasketTimerNativeItemInfoDark = -14,
	
	UIBasketTimerNativeItemDisclosure = -15,
	
	UIBasketTimerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BasketTimer instances of
