 ...
 * Copyright (c) 2009-2011 by BasketTimer, Inc. All Rights Reserved.
...
//@interface BasketTimerObject : NSObject
//@end

@interface BasketTimerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BasketTimerObject class]])
		{
			for (NSString *key in [[(BasketTimerObject*)o modules] allKeys])
			{
