...
/**
 The base class for all BasketTimer modules
 */
...
/**
 BasketTimer Platform calls this method on startup.
 */
-(void)startup;

/**
 BasketTimer Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 BasketTimer Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 BasketTimer Platform calls this method on resume.
 @param sender The sender of the event.
 */
