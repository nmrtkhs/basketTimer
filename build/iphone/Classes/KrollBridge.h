...
@interface BasketTimerObject : KrollCoverageObject {
#else
@interface BasketTimerObject : KrollObject {
#endif
@private
...
extern NSString * BasketTimer$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	BasketTimerObject *_baskettimer;
	BOOL shutdown;
